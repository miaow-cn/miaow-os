 ...
 *
 * Imported from Linux 2.4.8 lib/vsprintf.c (GPL-2.0-only); see
 * docs/third-party.md for the third-party inventory. Ported to this
 * freestanding tree: kernel-internal headers replaced by <stddef.h> and
